...
echo "Modifying CSS..."
# Background
sed "s/#FFFFFE/#050814/gi" -i "${1}-explorer/node_modules/insight-ui-komodo/public/css/main.min.css"
sed "s/#FFFFFE/#050814/gi" -i "${1}-explorer/node_modules/insight-ui-komodo/public/css/common.min.css"
